      ...
      mActiveConfig(0)
{
    ...
    ALOGE("intersectclip draw2 bounds [%d %d]",mDisplayWidth ,mDisplayHeight);
    //test
    ...
    ALOGE("Frame: mFrame.left %d, mFrame.top %d, mFrame.right %d, mFrame.bottom %d",mFrame.left, mFrame.top, mFrame.right, mFrame.bottom);
...
void DisplayDevice::setProjection(int orientation,
    ...
    ALOGE("viewport: srcview.w %f, srcview.h %f, dstframe.w %f, dstframe.h %f", src_width, src_height, dst_width, dst_height);
    ...
    if (src_width != dst_width || src_height != dst_height) {
        ...
        //S.set(sx, 0, 0, sy);
        //test 1.10
        ALOGE("viewport sx: %f sy: %f orientation = %d", sx, sy, orientation);
    }
    ...
    //test 1.10
    ALOGE("viewport Frame 665: Frame.left %d, Frame.top %d, Frame.right %d, Frame.bottom %d",mFrame.left, mFrame.top, mFrame.right, mFrame.bottom);
    TL.set(-src_x, -src_y);
    TP.set(dst_x, dst_y);
